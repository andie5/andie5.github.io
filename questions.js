...
//function(questions){
  ...
  var multiplyQuestions = function(numbers){
    return [
      ...
      "Mary has "+numbers[0]+" earring(s) in each box. There are "+numbers[1]+" box/boxes. What is the total number of earrings?",
      ...
      "Fiona has "+numbers[0]+" coloured rock(s) in each box. There are "+numbers[1]+" box/boxes. How many coloured rocks altogether?"
    ];
  }
  ...
  var divideQuestions = function(numbers){
    return [
      ...
      "David has "+numbers[0]+" coloured bead(s) and "+numbers[1]+" box/boxes, if David shares the bead(s) equally how many in each box? There may be some left over.",
      ...
      "Rita havs "+numbers[0]+" bean(s) and "+numbers[1]+" box/boxes. If Rita shares the bean(s) equally how many in each box? There may be some left over.",
